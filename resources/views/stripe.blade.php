                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 col-md-12">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="floatingInput" placeholder="City or Village">
                                ...
                                <div class="row">
                                    <div class="col-xl-12 col-md-12">
                                        <div class='form-floating card mb-3 required'>
                                            <input autocomplete='off' class='form-control' id="floatingInput" placeholder="Course Name">
                                            <label for="floatingInput">Course Name</label> 
                                        </div>
                                    </div>
                                    <div class="col-xl-12 col-md-12">
                                        <div class='form-floating card mb-3 required'>
                                            <input autocomplete='off' class='form-control' id="floatingInput" placeholder="Amount">
